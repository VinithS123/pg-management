...
class CustomerServiceTest {
    ...
    void addCustomerSuccess() {
        ...
        roomEntity.setRoomNo(101);
        roomEntity.setUserId(100L);
        roomEntity.setRoomStatus(RoomStatus.UNRESERVED);

        when(roomRepo.findByUserIdAndRoomNo(100L,101)).thenReturn(Optional.of(roomEntity));
